...
class S implements WidgetsLocalizations {
  ...
  String get passwordShouldBeMoreThan7Char => 'Password Should Be More Than 7 Char and Contain at least (2 number, 1 capital letter, 1 small letter)';

  String get emptyConfirmPassword => 'Empty Confirm Password';

  String get confirmPasswordDoesntMatchWithPassword => 'Confirm Password Doesn\'t Match With Password';
  ...
  String get enterYourVerification => 'Enter your verification code that we sent you to';
  ...
  String get about => "Enter a few details about yourself to tell people who you are.";
  ...
  String get enterYourEmailAndWeWillSendFourNumber => 'Enter your e-mail and we will send you 4 digits code for verification.';
  ...
  String get enterYourPhoneAndWeWillSendFourNumber => "Enter your phone number and we will send you 4 digits code for verification via SMS.";

  String get cantUsePhone => "Can’t use Phone Number? ";

  String get useEmailAddress => "Use E-mail";

  String get createNewPassword => "Create your new password and type new password twice.";
  ...
  String get whatFieldOfServiceDoYouWant => "What Field Of Service Do You Want To Provide?";

  String get whatFieldOfServiceDoYouWantEx => "Ex: Art & Designer";

  String get whatAreTheMainServiceYouOffer => "What Are The Main Services You Offer?";
  ...
  String get determineForServiceProvider => "Determine the fee for the service provided";
  ...
  String get userNameShouldBeMoreThan2Char => 'Username Should Be More Than 2 Char and Contain String Only';
  ...
  String get enterAllDetails => "Enter all the details of the service you want us to carry out for you so that the team can help you as soon as possible.";
  ...
  String get changePasswordText => "To set a new password, Please enter your current password first.";
  ...
  String get viverramaurisaliquetIntegerelem => "Viverra mauris  aliquet. Integer elem  ";
  ...
  get chooseNuberOfService => "Choose 2-4 services categories and we’ll optimize the services for you.";

  get noDataAdded => "No Available Data";

  get userTypeNotMatch => 'User Type Not Match, please got to Login Page that match your user type';
  ...
  get waitingforreceivefromthefreelancer => 'Waiting for receive from the freelancer';
  ...
  get clearTeam => "You are about to clear the team. Do you want to clear the team already?";

  get exitFromTeam => "You are about to leave the team... Do you want to leave the team already?";
...
class $ar extends S {
  ...
  @override
  String get passwordShouldBeMoreThan7Char => 'يجب أن تكون كلمة المرور أكثر من 7 أحرف وتحتوي على (2 رقم ، 1 حرف كبير ، 1 حرف صغير) على الأقل';

  @override
  String get emptyConfirmPassword => 'تأكيد كلمة المرور فارغ';

  @override
  String get confirmPasswordDoesntMatchWithPassword => 'كلمة المرور غير متطابقة مع كلمة المرور';
  ...
  @override
  String get enterYourEmailAndWeWillSendFourNumber => 'أدخل بريدك الإلكتروني وسنرسل لك رمزًا مكونًا من 4 أرقام للتحقق.';
  ...
  @override
  String get enterYourPhoneAndWeWillSendFourNumber => "أدخل رقم هاتفك وسنرسل لك رمزًا مكونًا من 4 أرقام للتحقق عبر الرسائل القصيرة.";
  ...
  @override
  String get createNewPassword => "قم بإنشاء كلمة مرور جديدة واكتب كلمة المرور الجديدة مرتين.";
  ...
  @override
  String get whatFieldOfServiceDoYouWant => "ما هو مجال الخدمة التي تريد تقديمها؟";

  @override
  String get whatFieldOfServiceDoYouWantEx => "مثال: الفن والمصمم";

  @override
  String get whatAreTheMainServiceYouOffer => "ما هي الخدمات الرئيسية التي تقدمها؟";
  ...
  @override
  String get userNameShouldBeMoreThan2Char => 'يجب أن يكون اسم المستخدم أكثر من 2 حرف ويحتوي على سلسلة فقط';
  ...
  @override
  String get enterAllDetails => "أدخل جميع تفاصيل الخدمة التي تريد منا تنفيذها لك حتى يتمكن الفريق من مساعدتك في أقرب وقت ممكن.";
  ...
  @override
  String get viverramaurisaliquetIntegerelem => "Viverra mauris aliquet integer element";
  ...
  @override
  get chooseNuberOfService => "اختر 2-4 خدمة...هذا سيساعدنا في تحديد الخدمات المناسب لك";
